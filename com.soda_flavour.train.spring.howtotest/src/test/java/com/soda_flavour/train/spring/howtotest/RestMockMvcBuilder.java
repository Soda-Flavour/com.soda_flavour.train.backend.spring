package com.soda_flavour.train.spring.howtotest;
...
import com.soda_flavour.train.spring.howtotest.RestMockMvcBuilder.RestMockMvc.MvcResultSupport;
...
public class RestMockMvcBuilder {
	...
	public static RestMockMvcBuilder of(WebApplicationContext context) {
		return new RestMockMvcBuilder(context);
	}

	private RestMockMvcBuilder(WebApplicationContext context) {
		this.context = context;
	}
	
	public RestMockMvcBuilder secure(boolean security) {
		this.security = security; return this;
	}
	public RestMockMvcBuilder docs(RestDocumentationContextProvider docs) {
		this.docs = docs; return this;
	}
	public RestMockMvcBuilder baseUri(String uri) {
...
//		protected static Log logger = LogFactory.getLog(RestMockMvc.class);
		...
		public static class MockMvcRequestSupport{
			...
			public MockMvcRequestSupport U(RestMockJwtBuilder mockUser) throws Exception{
				builder.with(authentication(mockUser.build()));
				return this;
			}
